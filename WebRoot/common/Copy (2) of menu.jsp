...
%>
	...
	<div class="nav_box">
		<div class="layout">
			<ul class="nav_list">
				<li class="nav_item current"><a class="nav_target" href="<%=basePath %>userAction.do?method=userMain">我的主页</a></li>
				<%
					if(canOperate(roleForm, "1") || canOperate(roleForm, "2") || canOperate(roleForm, "9"))
					{
				%>
				<li class="nav_item"><a class="nav_target">权限管理</a>
				...
				<%
					...
					{
				%>
				<li class="nav_item"><a class="nav_target">用户管理</a>
					<ul class="nav_sublist">
				...
				<%
					...
					{
				%>				
				<li class="nav_item"><a class="nav_target">文件管理</a>
					<ul class="nav_sublist">
				...
				<%
					...
					{
				%>	
				<li class="nav_item"><a class="nav_target">日常查询</a>
					<ul class="nav_sublist">
				...
				%>	
				<li class="nav_item"><a class="nav_target">系统管理</a>
					<ul class="nav_sublist">
