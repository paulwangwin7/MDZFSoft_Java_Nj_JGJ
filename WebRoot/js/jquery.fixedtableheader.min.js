		...
		if ($tblhfixed.find(headerelement).length > 0) {
			...
			$(window).scroll(function () {
				if (jQuery.browser.msie && jQuery.browser.version == "6.0") {
					$clonedTable.css({"position":"absolute","background-color":"#95BB2F", "top":$(window).scrollTop(), "left":$tbl.offset().left});
				} else {
					$clonedTable.css({"position":"fixed","background-color":"#95BB2F","top":"0", "left":$tbl.offset().left - $(window).scrollLeft()});
				}
