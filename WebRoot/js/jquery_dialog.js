...
(function($) {
	...
	var weebox = function(content,options) {
		...
		this.initEvent = function() {
			self.dh.find(".dialog-close, .dialog-cancel, .dialog-ok,.Js_closePar").unbind('click').click(function(){self.close()});			
		...
		this.close = function(n) {
			...
			try{document.getElementById('video').outerHTML = "";}catch(e){}
		}
		//取得遮照高度
